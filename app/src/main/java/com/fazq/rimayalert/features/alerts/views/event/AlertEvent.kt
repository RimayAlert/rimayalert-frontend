package com.fazq.rimayalert.features.alerts.views.event
...
sealed class AlertEvent {
    ...
    data object DismissLocationDialog : AlertEvent()
    data object RefreshLocation : AlertEvent()

    data class ConfirmLocationEdit(
        val address: String,
        val latitude: Double?,
